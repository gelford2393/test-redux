...
const Cards = (props: IProps) => {
    ...
    return (
        <div key={props.i} className={`Toast Toast--${props.category}`}>
            <div style={{width: 200}}><span className='Icons'><img src={props.category === "success" ? megaphone : alertCircle} alt="" /></span><span>{props.category === "success" ? "Announcement" : "Event Error"}</span></div>
